...
BUCKET = os.environ.get("GCP_GCS_BUCKET", "prefect-de-zoomcamp-steel-aria")
...
def upload_to_gcs(bucket, object_name, local_file):
    ...
    client = storage.Client(project='personal')
...
def web_to_gcs(year, service):
    for i in range(9, 12):
        ...
        print(request_url)
        temp = pd.read_csv(request_url, compression='gzip')
